...
Once this initial step has completed, you may be presented with a check. At this point you need to connect your computer to the Indaba WiFi network you have prepared, with an IP range of `10.10.10.*`. Indaba will attempt to autoconfigure your computer to match these settings.
