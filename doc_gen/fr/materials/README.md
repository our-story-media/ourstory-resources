...
<ul><li> Raffinement des balises utilisées pour correspondre à votre flux de travail </li></ul> 

</Leader> 

## <New/> Déploiements à distance sociale  
...
##  Brochure d&#39;information  
 ...
 Cette brochure est conçue pour donner un aperçu du processus Indaba pour des informations de haut niveau uniquement. A imprimer sur A4 et plié en livret en <a href="https://en.wikipedia.org/wiki/Brochure#/media/File:Folding.svg">trois volets (1)</a> .  

<translated-dropdown title="Trois volets (PDF)" :langs="['en','es']" link="https://github.com/our-story-media/ourstory-resources/raw/master/field-materials/booklet/brochure-%%.pdf"/> 
...
##  Cartes d&#39;histoire  
 ...
 <em>Pour les imprimer vous-même sur une imprimante A4 normale, utilisez les fichiers suivants. Ceux-ci doivent être imprimés en <strong>recto verso</strong> et en plusieurs <strong>pages</strong> pour obtenir les bons résultats recto verso.</em>  
...
##  Liste des équipements de référence  

 Vous êtes invités à utiliser tout équipement que vous pouvez vous procurer, mais nous fournissons cette liste comme référence d&#39;un kit que nous avons utilisé et dont nous savons qu&#39;il fonctionne bien sur le terrain.  
...
<ul><li> Accès administrateur requis (pour installer des applications) </li></ul> 
...
<ul><li> Projecteur vidéo (pour la projection communautaire à la fin du processus) </li></ul> 
<ul><li> Microphones à revers câblés (pour une meilleure qualité sonore dans les enregistrements) </li></ul> 

###  Kit de référence testé  

 <em>Les prix sont des estimations, d&#39;autres marques et fournisseurs existent, cela n&#39;est donné qu&#39;à titre indicatif.</em>  
 ...
 | 1 | Station de recharge | 22 GBP | <a href="https://www.amazon.co.uk/Anker-PowerPort-Family-Sized-Technology-Smartphones-Black/dp/B00PK1IIJY/ref=sr_1_20?s=electronics&amp;ie=UTF8&amp;qid=1530862198&amp;sr=1-20&amp;keywords=anker+charger">https://www.amazon.co.uk/Anker-PowerPort-Family-Sized-Technology-Smartphones-Black/dp/B00PK1IIJY/ref=sr_1_20?s=electronics&amp;ie=UTF8&amp;qid=1530862198&amp;sr=1-20&amp;keywords=anker+charger</a> |  

##  l&#39;image de marque  

 Vous êtes libre d&#39;utiliser la marque Indaba comme vous le souhaitez, téléchargez-la à partir du <a href="https://github.com/our-story-media/ourstory-resources/tree/master/branding">dossier de ressources GitHub</a>  

##  Remerciements  

 L&#39;équipe Indaba a reçu l&#39;aide et le soutien de diverses personnes, notamment:  
