...
<translated-dropdown title="Guía de distanciamiento social (PDF)" :langs="['en','es']" link="https://github.com/our-story-media/ourstory-resources/raw/master/field-materials/facilitator-guide-distance/print-yourself/distance-guide-selfprint-%%.pdf"/> 
...
##  Folleto informativo  
 ...
 Este folleto está diseñado para dar un resumen del proceso de Indaba solo para información de alto nivel. Para imprimir en A4 y plegar en un folleto de <a href="https://en.wikipedia.org/wiki/Brochure#/media/File:Folding.svg">tres pliegues (1)</a> .  
...
<translated-dropdown title="Imprimir varios (A4) (PDF)" :langs="['en','es','ar','fr']" link="https://github.com/our-story-media/ourstory-resources/raw/master/field-materials/story-cards/print-yourself/storycards-selfprint-%%.pdf"/> 
 ...
 <em>Las tarjetas también están disponibles en formato grande. Están diseñados para imprimirse en páginas individuales y doblarse en el centro.</em>  

<translated-dropdown title="Imprimir formato grande (A4) (PDF)" :langs="['en','es','ar','fr']" link="https://github.com/our-story-media/ourstory-resources/raw/master/field-materials/story-cards/large-print/printable-large-A4-%%.pdf"/> 
...
##  Dado  
 ...
 Dependiendo del proceso de <a href="/es/guide/ideation/">Ideación</a> que elija adoptar, es posible que necesite dados con forma para ayudar a configurar las tarjetas con la comunidad.  
...
##  Lista de equipos de referencia  
 ...
 Puede utilizar cualquier equipo que pueda obtener; sin embargo, proporcionamos esta lista como referencia de un equipo que hemos utilizado y sabemos que funciona bien en el campo.  

<Tip> 

 Aunque la infraestructura de Indaba es flexible y se puede utilizar en muchos contextos, necesitará una cantidad mínima de tecnología para iniciar una implementación.  

</Tip> 

###  Equipo mínimo requerido para online  
...
<ul><li> Baterías extra para portátiles </li></ul> 
<ul><li> Proyector de video (para proyección comunitaria al final del proceso) </li></ul> 
<ul><li> Micrófonos de solapa con cable (para una mejor calidad de sonido en las grabaciones) </li></ul> 
...
##  Marca  
 ...
 Puede usar la marca Indaba como desee, descárguela de la <a href="https://github.com/our-story-media/ourstory-resources/tree/master/branding">carpeta de recursos de GitHub</a>  
